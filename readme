...
Navigate to the root directory of the app in a terminal or command prompt.
Run npm install or yarn install to install the app's dependencies.
Rename .env.example to .env and replace the values with your own MongoDB Atlas credentials.
Running the App Locally
To run the app locally, follow these steps:

Make sure Docker is running on your machine.
Navigate to the root directory of the app in a terminal or command prompt.
Run docker-compose up to start the app in a Docker container.
